    ...
    <DashboardShell navItems={teacherNav} roleLabel="Teacher" roleColor="gradient-secondary">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500">Post announcements for your classes</p>
        </div>
        <button onClick={() => setShowCreate(true)} className="px-5 py-2.5 rounded-xl gradient-secondary text-white font-semibold shadow-lg hover:shadow-xl transition-all">
          + New Announcement
        </button>
      </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg animate-scale-in">
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button type="submit" disabled={saving} className="flex-1 py-3 rounded-xl gradient-secondary text-white font-semibold disabled:opacity-50">
